			    ...
			    <div className="row">
			      <div className="col-lg-3 col-sm-6">
			        <div className="single-destinations-list style-two wow animated fadeInUp" data-wow-duration="0.4s" data-wow-delay="0.1s">
			          ...
			          <div className="details">
			            <p className="location"><img src={publicUrl+"assets/img/icons/1.png"} alt="map" />Gambia</p>
			            <h4 className="title">Hurawalhi Island</h4>
			            <p className="content">7 Days Tour  2 People</p>
			      ...
			      <div className="col-lg-3 col-sm-6">
			        <div className="single-destinations-list style-two wow animated fadeInUp" data-wow-duration="0.7s" data-wow-delay="0.2s">
			          ...
			          <div className="details">
			            <p className="location"><img src={publicUrl+"assets/img/icons/1.png"} alt="map" />Senegal</p>
			            <h4 className="title">Pink Lake-Toubacouta...</h4>
			            <p className="content">4 days 2 People</p>
			            <div className="tp-price-meta">
			      ...
			      <div className="col-lg-3 col-sm-6">
			        <div className="single-destinations-list style-two wow animated fadeInUp" data-wow-duration="0.9s" data-wow-delay="0.3s">
			          ...
			          <div className="details">
			            <p className="location"><img src={publicUrl+"assets/img/icons/1.png"} alt="map" />Guinea Bissau</p>
			            <h4 className="title">Archipel de Bolama...</h4>
			            <p className="content">4 days 4 People</p>
			            <div className="tp-price-meta">
			      ...
			      <div className="col-lg-3 col-sm-6">
			        <div className="single-destinations-list style-two wow animated fadeInUp" data-wow-duration="1.1s" data-wow-delay="0.4s">
			          ...
			          <div className="details">
			            <p className="location"><img src={publicUrl+"assets/img/icons/1.png"} alt="map" />Burkinafaso</p>
			            <h4 className="title">Nabayius Gou...</h4>
			            <p className="content">3 days 2 People</p>
			            <div className="tp-price-meta">
			              <h2>620 <small>$</small></h2>
			            </div>
			          </div>
